-- Fix missing RLS policies with correct naming
...
CREATE POLICY "Users can view presence status in their organization"
...
CREATE POLICY "Users can modify their own presence status"
